...
const char * const mixerNames[] = {
    ...
    "AIRPLANE", "HELI_120_CCPM", "HELI_90_DEG", "VTAIL4", "CUSTOM", "HEXAV6", NULL
};
...
const clivalue_t valueTable[] = {
    ...
    { "pitch_min", VAR_UINT16, &cfg.pitch_min, 0, 2000 },
    { "pitch_mid", VAR_UINT16, &cfg.pitch_mid, 0, 2000 },
    { "pitch_max", VAR_UINT16, &cfg.pitch_max, 0, 2000 },
    { "yaw_min", VAR_UINT16, &cfg.yaw_min, 0, 2000 },
    { "yaw_mid", VAR_UINT16, &cfg.yaw_mid, 0, 2000 },
    { "yaw_max", VAR_UINT16, &cfg.yaw_max, 0, 2000 },
    { "flaperons", VAR_INT8, &cfg.flaperons, 0, 1 },
    { "flap_aux", VAR_INT8, &cfg.flap_aux, AUX1, AUX4 },
    { "vtail", VAR_INT8, &cfg.vtail, 0, 1 },
